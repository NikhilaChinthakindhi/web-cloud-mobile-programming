...
public class Sql_helper extends SQLiteOpenHelper {
    public static final String DATABASE_NAME = "recordlisten.db";
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table " + TABLE_NAME +" (ID INTEGER PRIMARY KEY AUTOINCREMENT,FNAME TEXT,LNAME TEXT,TOTAL INTEGER)");
    }
